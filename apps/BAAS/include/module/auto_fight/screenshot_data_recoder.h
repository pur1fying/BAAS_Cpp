...
#ifndef BAAS_CPP_MODULE_AUTO_FIGHT_SCREENSHOT_DATA_RECORDER_H_
#define BAAS_CPP_MODULE_AUTO_FIGHT_SCREENSHOT_DATA_RECORDER_H_
#include <optional>
#include <string>
#include <vector>
...
#endif //BAAS_CPP_MODULE_AUTO_FIGHT_SCREENSHOT_DATA_RECORDER_H_
