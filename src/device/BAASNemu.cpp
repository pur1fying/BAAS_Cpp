...
void BAASNemu::click(int x, int y) {
    update_resolution();
...
void BAASNemu::long_click(int x, int y, double duration){
    update_resolution();
    convertXY(x, y);
    down(x, y);
...
void BAASNemu::long_click(BAASPoint point, double duration){
    long_click(point.x, point.y, duration);
}

void BAASNemu::swipe(int start_x, int start_y, int end_x, int end_y, int step_len, double step_duration){
    update_resolution();
...
void BAASNemu::down(int x, int y) const {
...
void BAASNemu::convertXY(int &x, int &y) const {
